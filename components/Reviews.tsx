...
// Matches the reference cards' avatar tints
const AVATAR_TINTS = [
  "bg-[#ffc61a] !text-ink",
  "bg-[#14b8a6]",
  "bg-[#7c3aed]",
...
export default function Reviews() {
  ...
  // No real reviews yet — show nothing rather than an empty 0.0-out-of-5 card
      ...
      <div className="mt-5 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        {visible.map((r, i) => (
          ...
          >
            ...
            <p className="mt-3 flex items-center gap-1.5 text-[11px] font-semibold text-verify">
      ...
      {REVIEWS.length > 6 && (
        <div className="mt-6 text-center">
          <button
            ...
            className="rounded-lg border border-accent px-7 py-2.5 text-[13px] font-bold uppercase tracking-wider text-accent transition hover:bg-accent hover:text-ink"
          >

    ...
    <div>
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <Link
          ...
          className="glow-accent rounded-lg bg-accent px-5 py-2.5 text-sm font-bold text-ink transition hover:bg-accent-2"
        >
          + Add product
        </Link>
      </div>
      ...
      {products.length === 0 ? (
        <div className="mt-6 rounded-xl border border-line bg-surface p-10 text-center">
          ...
          <Link
            href="/admin/products/new"
            className="mt-4 inline-block rounded-lg bg-accent px-6 py-2.5 text-sm font-bold text-ink transition hover:bg-accent-2"
          >
